...
export default function App() {
  ...
  const handleSubmit = (e) => {
    ...
    setTodos(() => {
      return [
        ...todos,
        { id: crypto.randomUUID(), title: newItems, description: descriptions },
      ];
    });
  };
  console.log(todos);
        ...
        {todos.map((todo) => {
          return (
            <>
              ...
              >
                <div className="flex items-center justify-between my-6 bg-indigo-300 rounded">
                  <h5 className="mb-2 text-2xl my-2 mx-1 font-bold tracking-tight text-gray-900 dark:text-white font-salsa">
                    {todo.title}
                  </h5>
